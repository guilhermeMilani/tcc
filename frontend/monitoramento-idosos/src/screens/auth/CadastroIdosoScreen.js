...
import { cadastrarIdoso } from '../../api/api';

export default function CadastroIdosoScreen({ navigation }) {
  const [form, setForm] = useState({
    nome: '', email: '', senha: '', telefone: '', condicoesSaude: ''
  });
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      ...
      <Text style={styles.subtitulo}>Crie sua conta de idoso</Text>
      ...
      {[
        ...
        { campo: 'condicoesSaude', placeholder: 'Condições de saúde (opcional)' },
